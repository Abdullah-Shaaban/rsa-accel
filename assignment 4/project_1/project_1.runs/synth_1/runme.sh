...
HD_PWD='/run/media/nicolas/Coisas/Work/mestrado/design_of_digital_systems/dds-group10/assignment 4/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log task2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source task2.tcl
