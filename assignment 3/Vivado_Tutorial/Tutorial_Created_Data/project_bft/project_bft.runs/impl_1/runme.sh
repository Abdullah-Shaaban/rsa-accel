...
HD_PWD='/run/media/nicolas/Coisas/Work/mestrado/design_of_digital_systems/dds-group10/assignment 3/Vivado_Tutorial/Tutorial_Created_Data/project_bft/project_bft.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bft.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bft.tcl -notrace
